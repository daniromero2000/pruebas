  ...
  <div class="col-md-12">
    <div class="box" style="box-shadow: 0px 2px 25px rgba(0, 0, 0, .25);">
      <div class="box-body">
        ...
        <table class="table table-borderless table-hover table-sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center">{{ $employee_identity->identity_number }}</td>
              <td class="text-center">{{ $employee_identity->expedition_date }}</td>
              <td class="text-center">{{ $employee_identity->city->city }}</td>
            </tr>
            @endforeach
            </th>
          </tbody>
        ...
        @else
        <span>Aún no tiene Identificación</span><br>
        @endif
        <div class="row">
          <div class="col">
