...
namespace Modules\Development\Http\Controllers\Admin\Sprints;
...
use Modules\Development\Entities\SprintStatus;
use DB;
use Session;
use Log;
...
class SprintsController extends Controller
{
    ...
    public function activate(Request $request)
    {
        ...
        $activeSprintInProject = $this->projectInterface->findProjectById($projectId)->activeSprints;
    ...
    public function complete(Request $request)
    {
        ...
        if ($sprint && $sprint->isComplete()) {
            ...
            $result = array(
                'message' => 'This sprint has been set to complete',
                'sprintMachineName' => $sprintName,
                'status' => 1
            );
        } else {
            $result = array(
                'message' => 'All issues in the sprint should be complete or archived before setting a sprint to complete',
                'sprintMachineName' => $sprintName,
                'status' => 0
            );
        }
